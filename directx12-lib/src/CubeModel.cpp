...
void CubeModel::initVertexBuffer(ID3D12Device* device)
{
    ...
    this->vertices_[4] = { { -0.75f, -0.75f, -0.75f }, { 0, 1 } }; // 左下奥
    this->vertices_[5] = { { -0.75f, 0.75f, -0.75f }, { 0, 0 } }; // 左上奥
    this->vertices_[6] = { { 0.75f, 0.75f, -0.75f }, { 1, 0 } }; // 右上奥
    this->vertices_[7] = { { 0.75f, -0.75f, -0.75f }, { 1, 1 } }; // 右下奥
